...
class _CheckAuthScreenState extends State<CheckAuthScreen> {
  ...
  Future<void> _checkStatus() async {
    ...
    try {
      debugPrint("CheckAuth: Checking for global semester promotion...");
      final academicRepo = AcademicRepository();
      await academicRepo.promoteSemester();
      ...
      debugPrint("CheckAuth: Status is $status, forceEntry: $forceEntry");
