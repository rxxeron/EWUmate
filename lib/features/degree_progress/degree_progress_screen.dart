  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(
          child: StreamBuilder<AcademicProfile>(
            ...
            builder: (context, snapshot) {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                if (mounted) {
                  // Only use earned+remained as total if remainedCredits is actually populated
                  // (i.e., Azure Function has enriched the data)
                  if (profile.remainedCredits > 0) {
                  ...
                  // If remainedCredits is 0 but we have earned credits,
                  // keep the default program total (140 for ICE)
