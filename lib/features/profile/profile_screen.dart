...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _populateFields(Map<String, dynamic> data) {
    ...
    setState(() {
      ...
      _stats = {
        ...
        'ongoingCourses': data['ongoing_courses'],
      };
      _advisingSlot =
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      // Sync with Auth metadata for quick access in Dashboard
      await _supabase.auth.updateUser(
        UserAttributes(data: {
          'full_name': _nameCtrl.text.trim(),
          'nickname': _nicknameCtrl.text.trim(),
    ...
    return Column(
      children: [
        EWUmateAppBar(
          ...
          showMenu: true,
          actions: [
            Padding(padding: const EdgeInsets.only(right: 8), child: saveButton),
          ],
        ),
        Expanded(
          child: _loading && _nameCtrl.text.isEmpty
              ? const Center(
      ...
      children: [
        Row(
          children: [
            ...
            _buildStatCard("Earned Credits", _stats['totalCredits']?.toString() ?? "0",
        ...
        Row(
          children: [
            ...
            _buildStatCard(
                "Doing Now",
                _stats['ongoingCourses']?.toString() ?? "0",
                Icons.book_online),
          ],
        ),
      ],
