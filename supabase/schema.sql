...
CREATE POLICY "Users can manage own exceptions" ON schedule_exceptions FOR ALL USING (auth.uid() = user_id);
...
CREATE POLICY "Broadcasts are public" ON admin_broadcasts FOR SELECT USING (true);
